            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                    {SUPPORTED_SECT_OPTIONS.map(s => (
                        <label key={s} className={`cursor-pointer px-4 py-2 rounded-full border transition-colors ${temple.sects.includes(s as any) ? 'bg-seiren-navy text-white border-seiren-navy' : 'bg-white text-gray-600 hover:bg-gray-50'}`}>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                    {MEMORIAL_TYPE_OPTIONS.map(m => (
                        <label key={m} className={`cursor-pointer px-4 py-2 rounded-full border transition-colors ${temple.supportedMemorialTypes.includes(m as any) ? 'bg-seiren-navy text-white border-seiren-navy' : 'bg-white text-gray-600 hover:bg-gray-50'}`}>
                                ...
                                <div key={plan.id} className="flex items-center gap-4 bg-white p-4 border rounded shadow-sm hover:shadow transition-shadow">
                                    ...
                                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-2">
                                        ...
                                        <div className="text-sm text-gray-600 flex flex-col justify-center">
                                            <div className="flex gap-4">
                                                <span className="font-bold text-seiren-navy">¥ {plan.price.toLocaleString()}</span>
