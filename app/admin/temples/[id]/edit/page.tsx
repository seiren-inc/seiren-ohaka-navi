    ...
    const renderBasicTab = () => (
        <div className="space-y-8 max-w-4xl animate-in fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div><label className="block text-sm font-bold text-text-primary mb-1">施設ID (自動)</label><input className="w-full border bg-bg p-2.5 rounded-lg text-text-muted" value={temple.id} disabled /></div>
                <div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                    {SUPPORTED_SECT_OPTIONS.map(s => (
                        <label key={s} className={`cursor-pointer px-4 py-2 rounded-full border transition-colors ${temple.sects.includes(s as any) ? 'bg-primary text-white border-primary' : 'bg-white text-text-secondary hover:bg-bg'}`}>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                    {MEMORIAL_TYPE_OPTIONS.map(m => (
                        <label key={m} className={`cursor-pointer px-4 py-2 rounded-full border transition-colors ${temple.supportedMemorialTypes.includes(m as any) ? 'bg-primary text-white border-primary' : 'bg-white text-text-secondary hover:bg-bg'}`}>
        ...
        <div className="space-y-8 max-w-4xl animate-in fade-in">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    {plans.length === 0 ? (
                        <div className="text-center text-text-muted py-12 border-2 border-dashed rounded-xl bg-bg">区画が登録されていません。<br />「新規区画登録」ボタンから作成してください。</div>
                    ) : (
                        <div className="grid gap-4">
                            {plans.map(plan => (
                                <div key={plan.id} className="flex items-center gap-4 bg-white p-4 border rounded shadow-sm hover:shadow transition-shadow">
                                    <GripVertical className="text-text-muted w-5 h-5 cursor-move" />
                                    {/* Thumbnail Placeholder */}
                                    <div className="w-16 h-16 bg-bg rounded overflow-hidden flex-shrink-0 flex items-center justify-center">
                                        <span className="text-xs text-text-muted font-bold">Plan</span>
                                    </div>
                                    ...
                                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-2">
                                        ...
                                        <div className="text-sm text-text-secondary flex flex-col justify-center">
                                            <div className="flex gap-4">
    ...
    return (
        <div className="max-w-6xl mx-auto pb-12">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-primary-dark">寺院編集: {temple.name}</h2>
                <div className="flex gap-2">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-white w-full max-w-2xl rounded-xl p-6 space-y-4 max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center border-b pb-2">
                            ...
                            <button onClick={() => setIsPlanModalOpen(false)}><X className="w-6 h-6 text-text-muted hover:text-text-secondary" /></button>
                        </div>

                        <div className="space-y-6">
                            {/* 1. Name */}
                            <div>
                                <label className="block text-sm font-bold text-text-primary mb-1">区画プラン名 <span className="text-red-500">*</span></label>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-text-primary mb-1">販売価格 (円) <span className="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-text-primary mb-1">年間管理費 (円)</label>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-text-primary mb-1">埋葬方法 <span className="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-text-primary mb-1">ペット共葬 <span className="text-red-500">*</span></label>
                            ...
                            {/* 6. Availability */}
                            <div>
                                <label className="block text-sm font-bold text-text-primary mb-1">空き状況 <span className="text-red-500">*</span></label>
                            ...
                            {/* 7. Notes */}
                            <div>
                                <label className="block text-sm font-bold text-text-primary mb-1">備考 (任意)</label>
