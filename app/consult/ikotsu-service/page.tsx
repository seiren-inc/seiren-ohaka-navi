                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-10 rounded-2xl shadow-lg border border-gray-100 space-y-8 max-w-3xl mx-auto">
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4 bg-gray-50 p-6 rounded-lg border border-gray-100">
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    />
                                    <span className="text-xs text-gray-500 self-center">※郵便番号で自動入力</span>
                                </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea name="message" className="w-full h-32 p-4 border rounded-lg focus:border-primary focus:ring-1 focus:ring-primary" placeholder="ご質問や、具体的なご希望などがあればご記入ください" value={formData.message} onChange={handleChange} />
                        </div>
                    </section>
