...
export function MapBlock({ address }: MapBlockProps) {
    return (
        <div className="bg-white border border-border rounded-xl overflow-hidden">
            <div className="aspect-video w-full bg-bg relative flex items-center justify-center">
                <p className="text-text-muted font-bold">Google Map Placeholder</p>
                {/* 
            ...
            <div className="p-4 flex items-start">
                ...
                <p className="text-sm text-text-primary font-bold">{address}</p>
            </div>
