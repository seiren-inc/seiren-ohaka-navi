...
const BURIAL_TYPES = [
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10" aria-hidden="true">
        ...
        <path d="M24 14v20M16 22h16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10" aria-hidden="true">
        <path d="M24 38V26M24 26L16 18M24 26L32 18M18 30L10 22M30 30L38 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10" aria-hidden="true">
        <rect x="10" y="18" width="28" height="22" rx="2" stroke="currentColor" strokeWidth="1.5" />
        <path d="M16 18V14a8 8 0 0116 0v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <circle cx="24" cy="29" r="3" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    ),
  },
];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F4F3F0]">
      ...
      <main className="flex-grow">
        ...
        {/* ======================== HERO ======================== */}
        <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-20 bg-[#0F2E3A]">
          {/* 背景テクスチャ */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_60%_40%,_rgba(30,76,95,0.8)_0%,_rgba(15,46,58,1)_100%)] z-0" />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div>
                <motion.div {...heroFade}>
                  <p className="text-secondary text-xs font-bold tracking-[0.2em] uppercase mb-6">
                    Ohaka Navi — 清蓮
                  </p>
                  <h1 className="font-serif text-white text-3xl md:text-4xl lg:text-5xl leading-[1.3] tracking-tight mb-6">
                    墓地・永代供養で<br />
                    迷ったら、<br />
                ...
                >
                  <Link
                    ...
                    className="inline-flex items-center px-4 py-2 bg-white/10 text-white/80 hover:bg-white/20 rounded-full text-sm font-medium transition-all border border-white/10"
                  >
                    まずは専門家に相談
        ...
        <section className="py-20 bg-[#F4F3F0]">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            <motion.div {...useFadeUp()} className="mb-12 text-center">
              <span className="text-secondary font-bold tracking-[0.18em] text-xs uppercase mb-3 block">
                Area Search
              </span>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <motion.div {...useFadeUp(0.1)}>
                <span className="text-secondary font-bold tracking-[0.18em] text-xs uppercase mb-5 block">
                  Concept
                </span>
                <h2 className="font-serif text-3xl md:text-4xl font-bold text-primary-dark mb-8 leading-[1.4]">
                  「売る」ためではなく<br />
                  「納得する」ための<br />
                  お手伝い。
                </h2>
        ...
        {/* ======================== 供養のカタチ ======================== */}
        <section className="py-24 bg-[#F4F3F0]">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
              ...
              {BURIAL_TYPES.map((item, i) => (
                <motion.div key={item.key} {...useFadeUp(i * 0.07)}>
                  <Link href={item.link} className="block h-full group">
                    <div className="h-full bg-white rounded-2xl border border-gray-100 p-8 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/5 hover:border-primary/20">
                      <div className="text-primary mb-6 transition-colors group-hover:text-secondary">
                        {item.icon}
                      </div>
                      <h3 className="font-serif text-xl font-bold text-primary-dark mb-3 group-hover:text-primary transition-colors">
                        {item.title}
                      </h3>
        ...
        <section className="py-24 bg-primary-dark relative overflow-hidden">
          {/* 背景装飾 */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_50%_50%,_rgba(30,76,95,0.6)_0%,_transparent_100%)]" />
          <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
            <motion.div {...useFadeUp()}>
              <span className="text-secondary font-bold tracking-[0.18em] text-xs uppercase mb-5 block">
                Free Consultation
              </span>
              <h2 className="font-serif text-2xl md:text-4xl font-bold text-white mb-6 leading-[1.4]">
                お墓のことで悩んだら、<br />
                まずは無料相談へ。
              </h2>
              <p className="text-white/50 mb-12 text-sm md:text-base leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link href="/consult/request-material">
                  <Button
                    size="lg"
                    className="bg-secondary hover:bg-secondary/90 text-white border-0 shadow-lg shadow-secondary/30 min-w-[220px] active:scale-[0.98] transition-transform font-bold"
                  >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white/30 text-white/80 hover:bg-white/10 hover:border-white/50 min-w-[220px] active:scale-[0.98] transition-transform"
                >
