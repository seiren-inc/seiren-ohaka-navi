...
export function ContactForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            contact: {
                ...
                email: "", // general contact might not strictly require email in this form design? Wait.
                // Looking at the form, there is NO email field! 
                // That might be an issue for a contact form. 
                // But I will stick to the fields present.
            },
            address: {
            ...
            // Add user mapping for schema compatibility
            user: {
                name: formData.name,
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8">
            <Card className="bg-white p-6 sm:p-10 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            name="name"
                            required
                            className="w-full h-12 bg-gray-50/50"
                            placeholder="山田 太郎"
                            value={formData.name}
                ...
                <div className="pt-6 text-center">
                    <Button type="submit" size="lg" className="w-full sm:w-2/3 shadow-xl shadow-primary/20 text-lg py-6" disabled={isSubmitting}>
