                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-text-secondary leading-loose max-w-2xl mx-auto">
                            ...
                            <span className="text-sm text-text-muted mt-2 block">※まだ決断していなくても問題ありません。まずは知識を整理しましょう。</span>
                        </p>
                    </div>
                    ...
                    <section className="mb-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-5 border border-border rounded-lg">
                                ...
                                <p className="text-sm text-text-secondary">子供がいない、または娘がお嫁に行ってしまい、お墓を継ぐ人がいなくなるケースです。</p>
                            </div>
                            <div className="p-5 border border-border rounded-lg">
                                <h3 className="font-bold text-lg text-primary-dark mb-2">お墓が遠方にある</h3>
                                <p className="text-sm text-text-secondary">住まいと霊園が離れており、高齢になってお墓参りや草むしりなどの管理が難しくなった場合です。</p>
                            </div>
                            <div className="p-5 border border-border rounded-lg">
                                <h3 className="font-bold text-lg text-primary-dark mb-2">管理や費用の負担</h3>
                                <p className="text-sm text-text-secondary">毎年の護持会費やお布施、修繕費用の負担を、子供の世代に残したくないという考えです。</p>
                            </div>
                            <div className="p-5 border border-border rounded-lg">
                                <h3 className="font-bold text-lg text-primary-dark mb-2">家族構成の変化</h3>
                                <p className="text-sm text-text-secondary">夫婦だけのお墓にしたい、ペットと一緒に入りたいなど、既存のお墓では叶えられない希望がある場合です。</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-20">
                        ...
                        <p className="text-xs text-text-muted mt-6 text-right">※自治体やお寺の状況により、順序や必要書類が異なる場合があります。</p>
                    </section>
                    ...
                    <section className="mb-20">
                        ...
                        <div className="bg-white border border-border rounded-xl overflow-hidden">
                            <table className="w-full text-sm text-left">
                                <thead className="bg-bg text-text-primary font-bold border-b border-border">
                                    <tr>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    <tr>
                                        ...
                                        <td className="px-6 py-4">10万円 〜 30万円<span className="text-xs text-text-muted block sm:hidden">※広さや立地による</span></td>
                                        <td className="px-6 py-4 text-text-muted hidden sm:table-cell">1㎡あたり10〜15万円が相場。重機が入らない場所は高くなる。</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 font-bold text-primary-dark">閉眼供養（お布施）</td>
                                        <td className="px-6 py-4">3万円 〜 10万円</td>
                                        <td className="px-6 py-4 text-text-muted hidden sm:table-cell">お寺へのお礼。「離檀料」として別途費用がかかる場合もある。</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 font-bold text-primary-dark">行政手続き</td>
                                        <td className="px-6 py-4">数千円</td>
                                        <td className="px-6 py-4 text-text-muted hidden sm:table-cell">自治体による発行手数料。</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 font-bold text-primary-dark">新しい納骨先の費用</td>
                                        <td className="px-6 py-4">5万円 〜 数百万円<span className="text-xs text-text-muted block sm:hidden">※タイプによる</span></td>
                                        <td className="px-6 py-4 text-text-muted hidden sm:table-cell">合祀墓なら安く、個別のお墓や高級納骨堂なら高くなる。</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <p className="text-xs text-text-muted mt-4 text-right">※金額はあくまで目安です。具体的な金額は石材店やお寺への確認が必要です。</p>
                    </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                            ...
                            <div className="flex flex-col bg-white border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
                                ...
                                <Link href="/guide" className="w-full">
                                    <Button variant="ghost" className="w-full bg-bg hover:bg-bg">
                                        供養の知識まとめへ
                                    </Button>
                                </Link>
                            </div>
