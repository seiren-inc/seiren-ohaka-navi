        ...
        <div className="bg-white rounded-xl shadow-sm border border-border p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {data.keyFeatures.map((feature, i) => (
                    <div key={i} className="flex gap-4 p-4 border-b border-border last:border-0 md:border-0">
                        <div className="shrink-0 text-secondary bg-blue-50 w-12 h-12 rounded-full flex items-center justify-center">
                            <CheckCircle2 className="w-6 h-6" />
                        </div>
                        <div>
                            <h3 className="font-bold text-lg text-primary-dark mb-1">{feature.title}</h3>
