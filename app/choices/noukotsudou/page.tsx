                        ...
                        <div className="bg-white border border-border rounded-xl p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                <div className="bg-bg p-4 rounded text-center">
                                    <span className="block text-sm font-bold text-text-muted mb-2">ロッカー型</span>
                                    <span className="block text-xl font-bold text-primary-dark">20万円 〜 80万円</span>
                                </div>
                                <div className="bg-bg p-4 rounded text-center">
                                    <span className="block text-sm font-bold text-text-muted mb-2">自動搬送型</span>
                                    <span className="block text-xl font-bold text-primary-dark">50万円 〜 150万円</span>
                                </div>
                                <div className="bg-bg p-4 rounded text-center">
                                    <span className="block text-sm font-bold text-text-muted mb-2">仏壇型</span>
