                ...
                <div className="max-w-6xl mx-auto">
                        ...
                        <div className="bg-primary rounded-3xl p-8 md:p-12 text-center relative overflow-hidden shadow-xl">
                            ...
                            <div className="relative z-10">
                                <Link href="/choices/diagnosis">
                                    <Button size="lg" className="bg-white text-primary hover:bg-bg border-none px-10 py-6 text-lg shadow-lg">
                    ...
                    <section className="mb-24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {/* 永代供養墓 */}
                            <div className="border border-border rounded-xl p-6 hover:shadow-md transition-shadow flex flex-col">
                                <div className="mb-4">
                                    ...
                                    <div className="bg-bg p-3 rounded text-xs text-text-muted mb-4">
                    ...
                    <section className="mb-24">
                        ...
                        <div className="overflow-x-auto pb-4">
                            <table className="w-full text-sm text-left border-collapse min-w-[600px]">
                                ...
                                <tbody className="divide-y divide-gray-200 border-x border-b border-border">
                                    <tr className="bg-white">
                                        <th className="p-4 bg-bg text-text-primary font-bold border-r border-border">費用</th>
                                        <td className="p-4">高め<br /><span className="text-xs text-text-muted">100〜300万円前後</span></td>
                                        <td className="p-4 text-secondary font-bold">抑えやすい<br /><span className="text-xs text-text-muted">10〜100万円前後</span></td>
                                        <td className="p-4">抑えやすい<br /><span className="text-xs text-text-muted">30〜150万円前後</span></td>
                                        <td className="p-4">中程度<br /><span className="text-xs text-text-muted">50〜200万円前後</span></td>
                                    </tr>
                                    <tr className="bg-white">
                                        <th className="p-4 bg-bg text-text-primary font-bold border-r border-border">承継者</th>
                                    ...
                                    <tr className="bg-white">
                                        <th className="p-4 bg-bg text-text-primary font-bold border-r border-border">個別安置</th>
                                        <td className="p-4">永続的</td>
                                        <td className="p-4">一定期間〜合祀</td>
                                        <td className="p-4">一定期間〜合祀<br /><span className="text-xs text-text-muted">※永続タイプもあり</span></td>
                                        <td className="p-4">一定期間〜合祀</td>
                                    </tr>
                                    <tr className="bg-white">
                                        <th className="p-4 bg-bg text-text-primary font-bold border-r border-border">宗教制約</th>
                                    ...
                                    <tr className="bg-white">
                                        <th className="p-4 bg-bg text-text-primary font-bold border-r border-border">管理の手間</th>
                        ...
                        <p className="text-xs text-text-muted text-right mt-2">※一般的な傾向です。個別の寺院・霊園により条件は異なります。</p>
                    </section>
