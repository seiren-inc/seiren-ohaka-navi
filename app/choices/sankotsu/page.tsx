        ...
        <div className="min-h-screen flex flex-col bg-white text-primary-dark">
            ...
            <main className="flex-grow pt-24 px-4 pb-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <section className="mb-20">
                        <h2 className="font-serif text-2xl font-bold text-primary border-b pb-4 mb-8 flex items-center">
                            <AlertCircle className="w-6 h-6 mr-3 text-text-muted" />
                            向かない可能性があるケース
                        </h2>
                        <div className="bg-bg rounded-xl p-8">
                            <ul className="space-y-6">
                                <li className="flex items-start">
                                    <span className="text-text-muted mr-3 flex-shrink-0 mt-1">●</span>
                                    <div>
                                        <h3 className="font-bold text-text-primary mb-1">手を合わせる「場所」が必要な場合</h3>
                                        <p className="text-sm text-text-secondary leading-loose">
                                ...
                                <li className="flex items-start">
                                    <span className="text-text-muted mr-3 flex-shrink-0 mt-1">●</span>
                                    <div>
                                        <h3 className="font-bold text-text-primary mb-1">親族間の合意形成が難しい場合</h3>
                                        <p className="text-sm text-text-secondary leading-loose">
                                ...
                                <li className="flex items-start">
                                    <span className="text-text-muted mr-3 flex-shrink-0 mt-1">●</span>
                                    <div>
                                        <h3 className="font-bold text-text-primary mb-1">後から遺骨を取り出したくなる可能性がある場合</h3>
                                        <p className="text-sm text-text-secondary leading-loose">
                        ...
                        <div className="bg-white border border-border rounded-xl p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                <div className="bg-bg p-4 rounded text-center">
                                    <span className="block text-sm font-bold text-text-muted mb-2">委託散骨（代行）</span>
                                    <span className="block text-xl font-bold text-primary-dark">5万円 〜 15万円</span>
                                </div>
                                <div className="bg-bg p-4 rounded text-center">
                                    <span className="block text-sm font-bold text-text-muted mb-2">合同散骨（乗船）</span>
                                    <span className="block text-xl font-bold text-primary-dark">10万円 〜 25万円</span>
                                </div>
                                <div className="bg-bg p-4 rounded text-center">
                                    <span className="block text-sm font-bold text-text-muted mb-2">チャーター散骨</span>
                    ...
                    <section className="mb-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <p className="text-sm text-text-secondary leading-loose mb-4">
