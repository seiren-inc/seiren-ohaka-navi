...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${BASE_URL}/guide/haka-jiman-cost`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
        ...
        { url: `${BASE_URL}/grave-closure/consult`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
        ...
        { url: `${BASE_URL}/partner`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
