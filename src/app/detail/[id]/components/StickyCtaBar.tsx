...
export function StickyCtaBar() {
    return (
        <div className="fixed bottom-0 left-0 right-0 py-3 px-4 bg-white/90 backdrop-blur-md border-t border-gray-200 z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] pb-safe">
