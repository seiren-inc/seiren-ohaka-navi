...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.ohakanavi.jp/about/strength" },
  openGraph: {
    title: "清蓮の強み｜中立・比較・伴走の3つの約束",
    description: "清蓮が大切にする「中立」「比較」「伴走」3つの約束。特定の霊園に偏らず、メリットもデメリットも正直にお伝えします。",
    url: "https://www.ohakanavi.jp/about/strength",
  },
};
